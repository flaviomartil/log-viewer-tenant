...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('file/log-viewer/img/log-viewer-32.png') }}">

    <title>Log Viewer{{ config('app.name') ? ' - ' . config('app.name') : '' }}</title>

    <!-- Style sheets-->
    <link href="{{ asset('file/log-viewer/app.css') }}" rel="stylesheet">
</head>
...
<script src="{{ asset('file/log-viewer/app.js') }}" ></script>
</body>
</html>
